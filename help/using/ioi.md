...
>abstract="Il codice IOI segnala che il cliente utilizza pacchetti Oak interni, importati tramite OSGi. Vengono esportati senza alcuna versione particolare e sono solo destinati all’utilizzo da parte di altri bundle Oak o servizi AEM di basso livello."

`IOI` segnala che il cliente utilizza pacchetti Oak interni, importati tramite OSGi. Vengono esportati senza alcuna versione particolare e sono solo destinati all’utilizzo da parte di altri bundle Oak o servizi AEM di basso livello.
